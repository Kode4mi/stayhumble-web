export function handleFileSelect(e: React.ChangeEvent<HTMLInputElement>, setSelectedImageName: React.Dispatch<React.SetStateAction<string>>, setSelectedImageURL: React.Dispatch<React.SetStateAction<string | undefined>>) {
