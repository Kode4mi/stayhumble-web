  ...
  return (
    <div>
      <div className="text-gray-500 text-xs p-4 flex flex-wrap ">
        ...
        <p className="mx-2">Zasady użytkowania</p>
        <p className="mx-2">Polityka prywatności</p>
        <p className="mx-2">Polityka dotycząca plików cookie</p>
        <p className="mx-2">Dostępność</p>
        <p className="mx-2">Informacja o reklamach</p>
        <p className="mx-2">Blog</p>
        <p className="mx-2">Status</p>
        <p className="mx-2">Praca</p>
